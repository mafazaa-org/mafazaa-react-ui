...
function SideSection({
  ...
  return (
    ...
    >
      <div
        className="max-lg:flex max-lg:items-center max-lg:justify-center flex-1 lg:w-1/2 relative 
          before:content-['']
          before:w-2/5
          before:h-1/2
          before:absolute
      ...
      <div
        ...
        className="flex-1 lg:w-1/2 flex flex-col items-start justify-center gap-4 px-4 lg:pr-28"
      >
